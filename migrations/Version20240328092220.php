 ...
 */
final class Version20240328092220 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscriber ADD CONSTRAINT FK_AD005B6929CCBAD0 FOREIGN KEY (forum_id) REFERENCES forum (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
