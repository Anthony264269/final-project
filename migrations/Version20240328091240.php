 ...
 */
final class Version20240328091240 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscriber ADD CONSTRAINT FK_AD005B6922AEFBC1 FOREIGN KEY (my_garage_id) REFERENCES my_garage (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
